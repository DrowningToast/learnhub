...
class QuizController extends Controller
{
    ...
    public function edit(string $id, Request $request)
    {
        ...
        $quiz = json_decode($chapter->quizz->quiz_data);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $chapter->quizz->update([
            'quiz_data' => $quizJson,
        ]);

        return redirect('/learn/' . $request->course_id)->with('success_message', 'แบบทดสอบถูกแก้ไขเรียบร้อยแล้ว');
    }
