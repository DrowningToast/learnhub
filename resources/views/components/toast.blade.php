<div class="absolute w-full flex flex-row justify-center rounded-xl">
    @if (session()->has('success_message'))
        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
            class="z-10 fixed top-10 w-fit shadow-xl flex flex-row items-center justify-center bg-white drop-shadow-xl px-12 py-3 rounded-xl">
    ...
    @if (session()->has('error_message'))
        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
            class="z-10 fixed w-fit shadow-xl flex flex-row items-center justify-center bg-white drop-shadow-xl px-12 py-3 rounded-xl">
            <div class=" font-semibold text-sm flex flex-row items-center gap-4 rounded-full">
