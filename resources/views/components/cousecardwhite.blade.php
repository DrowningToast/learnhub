<div class="bg-[#FFFFFF] flex rounded-2xl w-full p-6 border-solid border-2 border-[#C1C7CE]">
    ...
    <div class="rounded-lg flex flex-col gap-y-3 w-full">
        ...
        <div class="h-full flex items-end ">
            <button type="button" class="bg-[#FFFFFF] text-black rounded-full w-full py-3 font-bold border-solid border-2 border-[#C1C7CE] font-noto-thai">Dowload File</button>
        </div>
    </div>
</div>